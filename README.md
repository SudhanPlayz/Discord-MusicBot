...
## 📝 | Important Note if youre Switching from v4 to v5
...
4. Run `npm run reploy` or `yarn deploy` to initialize the slash commands. _You can do this on your pc locally_
