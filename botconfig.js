module.exports = {
  ...
  Token: process.env.Token || "OTcwMDkyNzU2OTAwOTA0OTYw.Ym27SA.66CfVKyAYOgfQGGyfBMxcODgSPY", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "970092756900904960", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "VHGC7r0q3pqazLVzZTbHd3qAvPnvNedq", //Discord Client Secret
  ...
  Presence: {
    ...
    name: "Green Badge Tears ", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "5d042f5d97064c99aeb5265172b97792", //Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "16607e9012004f429d3533eae9607267", //Spotify Client Secret
  },
};
