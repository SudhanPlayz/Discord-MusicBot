module.exports = {
  ...
  ClientID: process.env.Discord_ClientID || process.env["Discord_ClientID"], //Discord Client ID
  ClientSecret:
    process.env.Discord_ClientSecret || process.env["Discord_ClientSecret"], //Discord Client Secret
