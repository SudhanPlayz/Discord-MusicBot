module.exports = {
  ...
  CookieSecret: process.env.Cookie || "Pikachu is cute", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Lavalink: {
    ...
    pass: process.env.LavaLink_Pass || "yourpass", //- The password of the lavalink server.
