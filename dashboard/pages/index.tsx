  ...
  return (
    <Container>
      ...
      <Container css={{display: 'flex', alignItems: 'center', background: '$gray50', position: 'fixed', padding: '20px', minWidth: '100%', left: '0', top: '0', zIndex: '$5'}}>
        ...
        <Link color='text' css={{fontSize: '$lg', fontWeight: '$medium', marginLeft: '20px'}} href='#features'>
          Features
        </Link>
      ...
      <Container style={{
        ...
        <Text h3 css={{color: '$gray800'}}>An advanced discord music bot, supports Spotify, SoundCloud, YouTube with Shuffling, Volume Control and Web Dashboard!</Text>
      ...
      <Container css={{display: 'flex',flexDirection: 'column', alignItems: 'center', minHeight: '60vh'}}>
        ...
        <Card isHoverable css={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '10px', width: '300px', padding: '20px', textAlign: 'center'}}>
      ...
      <Container css={{marginTop: '30px', display: 'flex',flexDirection: 'column', alignItems: 'center', minHeight: '60vh'}}>
