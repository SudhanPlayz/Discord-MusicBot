        ...
        >
            ...
            >
                ...
                <Text h3 css={{ color: '$gray800' }}>
                    ...
                    YouTube with Shuffling, Volume Control and Web Dashboard!
                </Text>
                <Container
                    css={{
                        display: 'flex',
                ...
                >
                    ...
                    >
                        ...
                        <Text css={{ color: '$gray800' }}>
                            Use your spotify playlist, youtube videos, youtube
                            playlists and much more using this bot
                        </Text>
                    </Card>
                    <Card
                        isHoverable
                    ...
                    >
                        ...
                        <Text css={{ color: '$gray800' }}>
                            This bot will never lag when playing any song in a
                            voice channel
                        </Text>
                    </Card>
                    <Card
                    ...
                    >
                        ...
                        <Text css={{ color: '$gray800' }}>
                            Control your song looping song or queue, play or
                            pause your song easily, or stop the bot completely.
                        </Text>
                    </Card>
                </Container>
            </Container>
