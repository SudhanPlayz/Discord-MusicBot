    ...
    this.manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = this.Embed()
          ...
          .setThumbnail(
            track.displayThumbnail("maxresdefault") || track.thumbnail
          )
      ...
      .on("queueEnd", (player) => {
        ...
        if (this.config.disconnectTime) {
          setTimeout(() => {
            player.destroy();
            let DisconnectedEmbed = new MessageEmbed()
              .setColor(this.config.embedColor)
              .setAuthor("Disconnected", this.config.iconURL)
      ...
      .on("queueEnd", (player, track, reason) => {
